					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									<span>异动类型：</span>
									<input type="checkbox" name="inLineOptions2" id="inlineRadio1" value="晋升" checked="checked"> 晋升&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="inLineOptions2" id="inlineRadio2" value="调动"> 调动&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="inLineOptions2" id="inlineRadio3" value="降职"> 降职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" name="inLineOptions2" id="inlineRadio3" value="调薪"> 调薪&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
