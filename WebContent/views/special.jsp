					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									<span>报&nbsp;&nbsp;货&nbsp;人：</span><input type="text" name="reserve5" id="reserve5" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>产品配置：</span><input type="text" name="reserve6" id="reserve6" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>收&nbsp;&nbsp;货&nbsp;人：</span><input type="text" name="reserve7" id="reserve7" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
								    <span>收货电话：</span><input type="number" name="reserve8" id="reserve8" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>收货地址：</span><input type="text" name="reserve9" id="reserve9" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>运货方式：</span><input type="text" name="reserve10" id="reserve10" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span><input type="number" name="reserve11" id="reserve11" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>公司名称：</span><input type="text" name="reserve12" id="reserve12" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>联&nbsp;&nbsp;系&nbsp;人：</span><input type="text" name="reserve13" id="reserve13" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>联系电话：</span><input type="number" name="reserve14" id="reserve14" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									<div class="iput">
										<span>申请原因：</span>
