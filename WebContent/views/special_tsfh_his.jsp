					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx">
									<span>报&nbsp;&nbsp;货&nbsp;人：</span><input type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>产品配置：</span><input type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>收&nbsp;&nbsp;货&nbsp;人：</span><input type="text" name="reserve7" value="${data.reserve7 }" id="reserve7" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
								    <span>收货电话：</span><input type="number" name="reserve8" id="reserve8" value="${data.reserve8 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>收货地址：</span><input type="text" name="reserve9" id="reserve9" value="${data.reserve9 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>运货方式：</span><input type="text" name="reserve10" id="reserve10" value="${data.reserve10 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span><input type="number" name="reserve11" id="reserve11" value="${data.reserve11 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>公司名称：</span><input type="text" name="reserve12" id="reserve12" value="${data.reserve12 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>联&nbsp;&nbsp;系&nbsp;人：</span><input type="text" name="reserve13" value="${data.reserve13 }" id="reserve13" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>联系电话：</span><input type="number" name="reserve14" id="reserve14" value="${data.reserve14 }" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									<div class="iput">
										<span>申请原因：</span>
										<input type="hidden" id="reserve115" value="${data.reserve15 }">
										<select name="reserve15" id="reserve15" style="width:300px;height:30px; border:none; background: #f5f5f5; margin-top: 15px;">
