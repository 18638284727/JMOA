							...
							<div class="nryc">
								...
								<div class="input-group1-2">
									<div class="iput">
											...
											<span>性别：</span>
										    <select style="width:180px;height:30px; border:none; background: #F5F5F5;" name="reserve11" id="reserve111">
											    <option value="不限">不限</option>
											    <option value="男">男</option>
											    <option value="女">女</option>
										    </select>
										    <input type="hidden" value="${data.reserve11 }" id="reserve11" />
											<span class="shu">|</span>
										    <span>年龄：</span>   
										    ...
										    <span class="shu">|</span>
										    <span>婚姻状况：</span>
										    <select style="width:180px;height:30px; border:none; background: #F5F5F5;" name="reserve12" id="reserve112">
											    <option value="不限">不限</option>
											    <option value="已婚">已婚</option>
											    <option value="未婚">未婚</option>
										    </select>
										    <input type="hidden" value="${data.reserve12 }" id="reserve12" />
									    </div>
									    <div class="iput">
											<span>学历：</span>
										    <select style="width:180px;height:30px; border:none; background: #F5F5F5;"name="reserve13" id="reserve113">
											    <option value="不限">不限</option>
										    ...
										    <span class="shu">|</span>
										    <span>经&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;验：</span>
										    <select style="width:180px;height:30px; border:none; background: #F5F5F5;" name="reserve14" id="reserve114">
											    <option value="不限">不限</option>
											    <option value="1-3年">1-3年</option>
											    <option value="3-5年">3-5年</option>
										    </select>
										    <input type="hidden" value="${data.reserve14 }" id="reserve14" />
